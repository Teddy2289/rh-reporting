...
class RolesAndPermissionsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $rh    = Role::firstOrCreate(['name' => 'rh',    'guard_name' => 'sanctum']);
        ...
        $rh->syncPermissions([
            ...
            'view planning', 'create planning', 'edit planning', 'delete planning', 'generate planning',
            'view leaves', 'create leaves', 'edit leaves', 'delete leaves', 'approve leaves',
            'view reports', 'export reports',
            'manage clients', 'manage missions',
        ]);

        // Manager : son équipe
        $manager->syncPermissions([
            'view agents',
            'view planning', 'create planning', 'edit planning',
